            ...
            <script type="text/javascript" data-keditor="script">
                $(function () {
                    $('#content-area').keditor({
                        extraTopbarItems: {
                            pageSetting: {
                                html: '<a href="builder.php" class="btn-back-setting" data-extra-setting="backSetting"><i class="fa fa-tachometer" aria-hidden="true"></i></a><a href="javascript:void(0);" class="btn-page-setting" data-extra-setting="pageSetting"><i class="fa fa-fw fa-cog"></i></a>'
                            }
                        },
                        extraSettings: {
                            pageSetting: {
